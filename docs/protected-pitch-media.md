...
Sound starts off. A viewer can enable a quiet synthesized ambient bed and transition effects. Pause, hidden tabs and Close suspend or release playback. Reduced-motion and data-saving preferences start with still images and manual navigation; Play is an explicit choice to load film.
