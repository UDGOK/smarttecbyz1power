...
export const downside=scenario('downside');
export const market=scenario('market');
export const contracted=scenario('contracted');
export const marketplaceHeavy=scenario('marketplace-heavy');
export const delayed=scenario('delayed');
export const maximum=scenario('maximum-base');
...
export const evidence=[
 {title:'Customer commitments',status:'Active discussions',detail:`No signed customer contract or paid pilot is established. The workbook Contracted case models ${contracted.commercial.contractedGpus} reserved GPUs at ${rate(contracted.commercial.contractRateUsd)} per GPU-hour, ${pct(contracted.commercial.contractPaidShare,0)} paid share and a ${contracted.commercial.contractTermMonths}-month term, with the other ${contracted.capacity.saleableGpus-contracted.commercial.contractedGpus} saleable GPUs on merchant assumptions. It is hypothetical; customer credit, minimum payments and service acceptance remain open.`},
